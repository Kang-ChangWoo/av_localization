...
Linear projection 1746 -> 128, trained on the 542 training rooms with an in-room InfoNCE over (furnished query, wall-only twin) pairs, selected on the validation rooms. In-room retrieval recall@1m on validation: identity 46.3%, projected 55.0%.
