# Detecting visual collapse and switching, UnLoc on Replica

## Separation of 'shortlist covers truth' from 'shortlist broken' (AUROC, higher means the indicator rises with collapse)
